...
def args_parser():
    ...
    args_algo.add_argument('--num_clients', '-K', type=int, default=5,
                        help="number of clients")
    args_algo.add_argument('--frac_clients', '-C', type=float, default=0.4,
                        help="fraction of clients selected at each round")
    args_algo.add_argument('--train_bs', '-B', type=int, default=1,
    ...
    args_algo.add_argument('--vc_size', type=int, default=None,
                        help="use FedVC algorithm with virtual client size VC_SIZE")#256
